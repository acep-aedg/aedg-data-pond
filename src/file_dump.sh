...
export_to_csv "final" "yearly_generation" "l3_es_yearly_generation"
export_to_csv "final" "monthly_generation" "l3_es_monthly_generation"
...
export_to_csv "final" "monthly_electric_revenue_per_kwh" "l3_es_monthly_revenue_per_kwh"
export_to_csv "final" "yearly_electric_revenue_per_kwh" "l3_es_yearly_revenue_per_kwh"
export_to_csv "final" "monthly_sales" "l3_es_monthly_sales"
export_to_csv "final" "yearly_sales" "l3_es_yearly_sales"
...
export_to_csv "public" "public_yearly_electric_revenue_per_kwh" "(SELECT * FROM public_yearly_electric_revenue_per_kwh)"
export_to_csv "public" "public_monthly_electric_revenue_per_kwh" "(SELECT * FROM public_monthly_electric_revenue_per_kwh)"
