...
export_to_geojson "public" "public_regional_corporations" "(SELECT * FROM public_regional_corporations)"
...
export_to_csv "final" "monthly_electric_rates" "l3_es_monthly_rates"
export_to_csv "final" "yearly_electric_rates" "l3_es_yearly_rates"
...
export_to_csv "public" "public_heating_degree_days" "(SELECT * FROM public_heating_degree_days)"
